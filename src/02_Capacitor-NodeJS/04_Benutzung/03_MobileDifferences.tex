\addurlfn{child_process}{child\_process}{https://nodejs.org/api/child_process.html}
\addurlfn{fs}{fs}{https://nodejs.org/api/fs.html}
\addurlfn{intl}{intl}{https://nodejs.org/api/intl.html}
\addurlfn{os}{os}{https://nodejs.org/api/os.html}
\addurlfn{process}{process}{https://nodejs.org/api/process.html}
...
\paragraph{\protect\fn{child_process} module}
...
\paragraph{file system (\protect\fn{fs}) module}
...
\paragraph{\protect\fn{process} module}
