...
Der WebApp-Wrapper bietet auf der Webseite eine \ac{api} an, um Konfigurationen des zu ändern und Nachrichten zwischen der Webseite und dem Node.js Projekt auszutauschen.
